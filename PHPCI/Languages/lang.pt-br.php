...
PHPCI',
    ...
    'webhooks_help_bitbucket' => 'Para compilar automaticamente este projeto cada vez que um commit for realizado, adicionar a seguinte URL
    ...
    'chart_display' => 'Este gráfico será exibido quando o build estiver completo.',
    ...
    'codeception_feature' => 'Funcionalidade',
    ...
    'github_sign_in' => 'Antes de começar a utilizar o GitHub, você precisa <a href="%s">acessar</a> e permitir
    ...
    'github_where_help' => 'Se você é proprietário da aplicação que você quer usar, pode encontrar esta informacão na
    ...
    'email_settings_help' => 'Para que PHPCI possa enviar email com o status dos builds,
                                você deve configurar as seguintes propriedades SMTP.',
    ...
    'please_answer' => 'Por favor, responda as seguintes perguntas:',
    ...
    'tap_version' => 'TapParser suporta apenas a versão 13 do TAP',
    'tap_error' => 'Cadeia de caracteres TAP inválida, o número de testes não coincide com a conta de testes definidos.',

    // Build Plugins:
    'no_tests_performed' => 'Não foram encontrados testes.',
    'could_not_find' => 'Não foram encontrados %s',
    'no_campfire_settings' => 'Os parâmetros de conexão para o plugin Campfire não foram especificados.',
    'failed_to_wipe' => 'Impossível eliminar o diretório existente %s antes de copia-lo',
    ...
    'property_file_missing' => 'O arquivo de propriedades especificado não existe.',
    'could_not_process_report' => 'Impossível processar o relatório gerado pela ferramenta.',
