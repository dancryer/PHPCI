 ...
 * PHPCI Build Runner
 *
 * Implements the base Builder features.
 *
 * @author   Adirelle <adirelle@gmail.com>
 */
class BaseBuilder implements LoggerAwareInterface
{
    /**
     * @var string
     */
    ...
    public function __construct(Build $build, LoggerInterface $logger = null)
    {
        ...
        $this->pluginExecutor = new Executor($pluginFactory, $this->buildLogger);
    ...
    public function removeBuildDirectory()
    {
        ...
        $this->commandExecutor->executeCommand(array($cmd, rtrim($this->buildPath, '/')));
    }
}
