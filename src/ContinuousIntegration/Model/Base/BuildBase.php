...
class BuildBase extends Model
{
    ...
    */
    ...
    public function getProject()
    {
        ...
        if (empty($rtn)) {
            $rtn    = Factory::getStore('Project', 'Kiboko\\Component\\ContinuousIntegration')->getById($key);
    ...
    */
    ...
    {
        return Factory::getStore('BuildError', 'Kiboko\\Component\\ContinuousIntegration')->getByBuildId($this->getId());
    }
    ...
    {
        return Factory::getStore('BuildMeta', 'Kiboko\\Component\\ContinuousIntegration')->getByBuildId($this->getId());
    }
}
