...
Falls nicht, ignorieren Sie diese Email bitte, es wird nichts geändert.
...
PHPCI',
    ...
    // Timeline:
    'latest_builds' => 'Die letzten Builds',
    'pending' => 'Ausstehend',
    ...
    'public_key_help' => 'Um Ihnen den Einstieg zu erleichtern, haben wir Ihnen ein SSH-Key-Paar für dieses Projekt
                            generiert. Um sie zu verwenden, fügen Sie einfach den folgenden Public Key im Abschnitt
    ...
    'project_private_key' => 'Private key für den Zugang zum Repository
                                (leerlassen für lokale und oder anonyme externe Zugriffe)',
    ...
    'webhooks_help_gitlab' => 'Um für dieses Projekt automatisch einen Build zu starten, wenn neue Commits gepushed
                                werden, fügen Sie die untenstehende URL in der Web Hooks Sektion Ihres Gitlab
                                Repositories hinzu',

    'webhooks_help_bitbucket' => 'Um für dieses Projekt automatisch einen Build zu starten, wenn neue Commits gepushed
                                werden, fügen Sie die untenstehende URL als "POST" Service in der
                                <a href="https://bitbucket.org/%s/admin/services">Services</a>-Sektion Ihres Bitbucket
                                Repositories hinzu',
    ...
    'lines_of_code' => 'Anzahl Zeilen Code',
    ...
    'settings_cannot_write' => 'PHPCI config.yml nicht schreiben. Einstellungen könnten nicht richtig gespeichert
    ...
    'build_settings' => 'Build-Einstellungen',
    'github_application' => 'Github Applikation',
    'github_sign_in' => 'Bevor Sie anfangen Github zu verwenden, müssen Sie sich erst <a href="%s">einloggen</a>
                            und PHPCI Zugriff auf Ihr Nutzerkonto gewähren',
    'github_phpci_linked' => 'PHPCI wurde erfolgreich mit Ihrem Github-Konto verknüpft.',
    'github_where_to_find' => 'Wo Sie diese finden...', // CONTEXT?
    ...
    'email_settings' => 'E-Maileinstellungen',
    ...
    // Plugins
    'cannot_update_composer' => 'PHPCI PHPCI kann composer.json nicht für Sie aktualisieren, da Schreibrechte
                                    benötigt werden.',
    'x_has_been_removed' => '%s wurde entfernt.',
    'x_has_been_added' => '%s wurde für Sie dem composer.json hinzugefügt und wird installiert, sobald Sie
                            das nächste map composer update ausführen.',
    'enabled_plugins' => 'Plugins einschalten',
    ...
    'welcome_to_phpci' => 'Willkommen im PHPCI',
    ...
    'must_be_valid_email' => 'Muss eine valide Emailadresse sein.',
    ...
    'update_instead' => 'Falls Sie versucht haben PHPCI zu updaten, benutzen Sie bitte stattdessen phpci:update.',

    // Update
    'update_phpci' => 'Datenbank wird geupdated, um den Änderungen der Models zu entsprechen.',
    'updating_phpci' => 'Update PHPCI-Datenbank: ',
    ...
    // Poll Command
    'poll_github' => 'Githubabfragen, um herauszufinden, ob ein Build gestartet werden muss.',
    ...
    'unable_to_set_env' => 'Konnte Umngebungsvariable nicht setzen',
    ...
    'could_not_process_report' => 'Konnte den von diesem Tool erstellten Raport nicht verarbeiten.',
