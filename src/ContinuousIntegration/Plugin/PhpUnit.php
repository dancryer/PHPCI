...
use Kiboko\Component\ContinuousIntegration\Plugin\Util\TapParser;
...
* @subpackage   Plugins
*/
class PhpUnit implements ContinuousIntegration\Plugin, ContinuousIntegration\ZeroConfigPlugin
{
    protected $args;
    protected $phpci;
    protected $build;
