 ...
 * Phar Plugin
 */
class Phar implements \Kiboko\Component\ContinuousIntegration\Plugin
{
    /**
     * PHPCI
     * @var Builder
    ...
    public function getDirectory()
    {
        if (!isset($this->directory)) {
            $this->setDirectory($this->getCI()->buildPath);
        }
    ...
    public function getStubContent()
    {
        ...
        if ($filename) {
            $content = file_get_contents($this->getCI()->buildPath . DIRECTORY_SEPARATOR . $this->getStub());
        }
        return $content;
    }
    ...
    public function execute()
    {
        ...
        try {
            ...
            $phar->buildFromDirectory($this->getCI()->buildPath, $this->getRegExp());
            ...
            $this->getCI()->log(Lang::get('phar_internal_error'));
            $this->getCI()->log($e->getMessage());
        }
