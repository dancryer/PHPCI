...
/**
 * Helper class for sending emails using Kiboko CI's email configuration.
 * @package PHPCI\Helper
 */
class Email
{
    const DEFAULT_FROM = 'Kiboko CI <no-reply@phptesting.org>';

    protected $emailTo = array();
    protected $emailCc = array();
    protected $subject = 'Email from Kiboko CI';
    protected $body = '';
