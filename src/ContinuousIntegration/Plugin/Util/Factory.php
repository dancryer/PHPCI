...
namespace Kiboko\Component\ContinuousIntegration\Plugin\Util;
...
class Factory
{
    ...
    const INTERFACE_KIBOKO_CI_APP_PLUGIN = 'Kiboko\\Component\\ContinuousIntegration\\Plugin';
    ...
    public function buildPlugin($className, $options = array())
    {
        ...
        if (!$reflectedPlugin->implementsInterface(self::INTERFACE_KIBOKO_CI_APP_PLUGIN)) {
            throw new \InvalidArgumentException(
                "Requested class must implement " . self:: INTERFACE_KIBOKO_CI_APP_PLUGIN
            );
        }
