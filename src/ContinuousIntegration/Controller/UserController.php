...
class UserController extends Controller
{
    ...
    /**
     * @var \Kiboko\Component\ContinuousIntegration\Service\UserService
     */
    ...
    */
    ...
    public function profile()
    {
        ...
        $form = new Form();
        $form->setAction(KIBOKO_CI_APP_URL.'user/profile');
        $form->setMethod('POST');
    ...
    */
    public function add()
    {
        ...
        $response->setHeader('Location', KIBOKO_CI_APP_URL . 'user');
        return $response;
    }
    ...
    */
    protected function userForm($values, $type = 'add')
    {
        $form = new Form();
        $form->setMethod('POST');
        $form->setAction(KIBOKO_CI_APP_URL.'user/' . $type);
