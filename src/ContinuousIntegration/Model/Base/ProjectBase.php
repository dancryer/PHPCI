...
class ProjectBase extends Model
{
    ...
    */
    ...
    public function getGroup()
    {
        ...
        if (empty($rtn)) {
            $rtn    = Factory::getStore('ProjectGroup', 'Kiboko\\Component\\ContinuousIntegration')->getById($key);
    ...
    */
    ...
    {
        return Factory::getStore('Build', 'Kiboko\\Component\\ContinuousIntegration')->getByProjectId($this->getId());
    }
    ...
    {
        return Factory::getStore('BuildMeta', 'Kiboko\\Component\\ContinuousIntegration')->getByProjectId($this->getId());
    }
}
