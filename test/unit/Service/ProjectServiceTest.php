...
class ProjectServiceTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->mockProjectStore = $this->getMock('Kiboko\\Component\\ContinuousIntegration\Store\ProjectStore');
    ...
    {
        $store = $this->getMock('Kiboko\\Component\\ContinuousIntegration\Store\ProjectStore');
