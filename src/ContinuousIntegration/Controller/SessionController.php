...
use b8;
use Kiboko\Component\ContinuousIntegration\Helper\Email;
...
* @subpackage   Web
*/
class SessionController extends \Kiboko\Component\ContinuousIntegration\Controller
{
    /**
     * @var \Kiboko\Component\ContinuousIntegration\Store\UserStore
     */
    protected $userStore;
    ...
    */
    public function login()
    {
        ...
        $form = new b8\Form();
        $form->setMethod('POST');
        $form->setAction(KIBOKO_CI_APP_URL.'session/login');
