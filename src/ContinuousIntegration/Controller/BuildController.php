...
* @subpackage   Web
*/
class BuildController extends \Kiboko\Component\ContinuousIntegration\Controller
{
    /**
    ...
    */
    public function view($buildId)
    {
        ...
        $rebuildLink = KIBOKO_CI_APP_URL . 'build/rebuild/' . $build->getId();

        $delete = Lang::get('delete_build');
        $deleteLink = KIBOKO_CI_APP_URL . 'build/delete/' . $build->getId();
    ...
    */
    protected function getBuildData(Build $build)
    {
        ...
        /** @var \Kiboko\Component\ContinuousIntegration\Store\BuildErrorStore $errorStore */
    ...
    */
    public function delete($buildId)
    {
        ...
        $response = new b8\Http\Response\RedirectResponse();
        $response->setHeader('Location', KIBOKO_CI_APP_URL.'project/view/' . $build->getProjectId());
        return $response;
    }
    ...
    */
    ...
    /**
     * Formats a list of builds into rows suitable for the dropdowns in the Kiboko CI header bar.
     * @param $builds
     * @return array
     */
