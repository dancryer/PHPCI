...
class SymfonyRequirements extends RequirementCollection
{
    ...
    public function __construct()
    {
        ...
        $this->addRequirement(
            ($this->checkBadLocale()),
            'Using deprecated timezone <strong>'.date_default_timezone_get().'</strong>',
    ...
    private function checkBadLocale()
    {
      $bad_locales = array(
        'Brazil/Acre',
        'Brazil/DeNoronha',
      ...
      if (in_array(date_default_timezone_get(), $bad_locales)) return false;
      return true;
    }
}
