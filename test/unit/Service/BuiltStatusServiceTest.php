...
namespace Kiboko\Component\ContinuousIntegration\Service\Tests;
...
class BuildStatusServiceTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function getProjectMock($prevBuildId = null, $setProject = true) {
        ...
        $project = $this->getMock('Kiboko\\Component\\ContinuousIntegration\Model\Project', array('getLatestBuild'));
