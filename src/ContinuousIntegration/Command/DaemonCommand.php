...
use Monolog\Logger;
use Kiboko\Component\ContinuousIntegration\ProcessControl\Factory;
use Kiboko\Component\ContinuousIntegration\ProcessControl\ProcessControlInterface;
...
class DaemonCommand extends Command
{
        ...
        $this
            ...
            ->addOption(
                ...
                implode(DIRECTORY_SEPARATOR,
                    array(KIBOKO_CI_APP_DIR, 'daemon', 'daemon.pid'))
            )
            ->addOption(
                'log-file', 'l', InputOption::VALUE_REQUIRED,
                'Path of the log file',
                implode(DIRECTORY_SEPARATOR,
                    array(KIBOKO_CI_APP_DIR, 'daemon', 'daemon.log'))
        );
    }
    ...
    protected function startDaemon()
    {
        ...
        $command = sprintf($cmd, KIBOKO_CI_APP_DIR, $this->logFilePath);
