...
/**
* Clean build removes Composer related files and allows Kiboko CI users to clean up their build directory.
* Useful as a precursor to copy_build.
* @author       Dan Cryer <dan@block8.co.uk>
* @package      PHPCI
* @subpackage   Plugins
*/
class CleanBuild implements \Kiboko\Component\ContinuousIntegration\Plugin
{
    protected $remove;
    protected $phpci;
    protected $build;
