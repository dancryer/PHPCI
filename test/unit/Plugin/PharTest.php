...
use Kiboko\Component\ContinuousIntegration\Plugin\Phar as PharPlugin;
use Phar as PHPPhar;
...
class PharTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $build = $this
            ->getMockBuilder('Kiboko\\Component\\ContinuousIntegration\Model\Build')
            ->disableOriginalConstructor()
            ->getMock();

        $phpci = $this
            ->getMockBuilder('Kiboko\\Component\\ContinuousIntegration\Builder')
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function testPlugin()
    {
        ...
        $this->assertInstanceOf('Kiboko\\Component\\ContinuousIntegration\Plugin', $plugin);
        $this->assertInstanceOf('Kiboko\\Component\\ContinuousIntegration\Model\Build', $plugin->getBuild());
        $this->assertInstanceOf('Kiboko\\Component\\ContinuousIntegration\Builder', $plugin->getCI());
    }

    public function testDirectory()
    {
        $plugin = $this->getPlugin();
        $plugin->getCI()->buildPath = 'foo';
...
STUB;
    ...
    public function testExecuteUnknownDirectory()
    {
        ...
        $plugin->getCI()->buildPath = $this->buildSource();
