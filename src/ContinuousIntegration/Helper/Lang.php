...
class Lang
{
    ...
    {
        print call_user_func_array(array('Kiboko\\Component\\ContinuousIntegration\\Helper\\Lang', 'get'), func_get_args());
    }
    ...
    public static function getLanguageOptions()
    {
        ...
        foreach (self::$languages as $language) {
            $strings = array();
            require(KIBOKO_CI_APP_DIR . 'app/translations/lang.' . $language . '.php');
    ...
    {
        $langFile = KIBOKO_CI_APP_DIR . 'app/translations/lang.' . self::$language . '.php';
    ...
    {
        $matches = array();
        foreach (glob(KIBOKO_CI_APP_DIR . 'app/translations/lang.*.php') as $file) {
